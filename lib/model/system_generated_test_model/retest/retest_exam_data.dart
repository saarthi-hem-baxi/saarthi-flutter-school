...
class RetestExamData {
  ...
  @override
  String toString() {
    return 'Data(id: $id, lang: $lang, type: $type, orId: $orId, keyLearnings: $keyLearnings, concepts: $concepts, tags: $tags, topics: $topics, book: $book, publisher: $publisher,  trueFalseAns: $trueFalseAns,askedInExams: $askedInExams, question: $question, answer: $answer, mcqOptions: $mcqOptions, comprehension: $comprehension, difficulty: $difficulty, isPublisher: $isPublisher, verify: $verify, createdBy: $createdBy, updatedBy: $updatedBy, status: $status, createdAt: $createdAt, updatedAt: $updatedAt, v: $v, concept: $concept, keyLearning: $keyLearning, startedAt: $startedAt,isRandom: $isRandom,hint: $hint,solution: $solution)';
  }

  factory RetestExamData.fromMap(Map<String, dynamic> data) {
    langCode = data['lang'] ?? "en_US";
    return RetestExamData(
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [RetestExamData].
  factory RetestExamData.fromJson(String data) {
    return RetestExamData.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [RetestExamData] to a JSON string.
