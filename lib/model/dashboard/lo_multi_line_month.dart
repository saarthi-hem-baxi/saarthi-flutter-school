...
LoMultiLineChartMonthModal loMultiLineChartMonthModalFromJson(String str) => LoMultiLineChartMonthModal.fromJson(json.decode(str));

String loMultiLineChartMonthModalToJson(LoMultiLineChartMonthModal data) => json.encode(data.toJson());

class LoMultiLineChartMonthModal {
  LoMultiLineChartMonthModal({
    this.chartData,
  });

  List<ChartMonthDatum>? chartData;

  factory LoMultiLineChartMonthModal.fromJson(Map<String, dynamic>? json) => LoMultiLineChartMonthModal(
