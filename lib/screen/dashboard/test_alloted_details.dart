...
class TestAllotedDetailsPage extends StatelessWidget {
  const TestAllotedDetailsPage({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const _TestAllottedSubjectsChart(),
                    SizedBox(
                      height: 10.h,
                    ),
                    Text(
                    ...
                    _TestAllottedChapterChart(),
                    SizedBox(
                      height: 10.h,
                    ),
                    Text(
                      "Concepts (Allotted/Completed)",
                      style: textTitle16WhiteBoldStyle.merge(
                        const TextStyle(color: colorHeaderTextColor),
                      ),
                    ),
                    _TestAllottedConceptList()
                  ],
                ),
              ),
            ),
...
class _TestAllottedSubjectsChart extends StatefulWidget {
  const _TestAllottedSubjectsChart({Key? key}) : super(key: key);

  @override
  State<_TestAllottedSubjectsChart> createState() =>
      _TestAllottedSubjectsChartState();
}

class _TestAllottedSubjectsChartState
    extends State<_TestAllottedSubjectsChart> {
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Row(
              children: [
                _TestAllotedSubjectChartTabHeader(
...
class _TestAllotedSubjectChartTabHeader extends StatelessWidget {
  const _TestAllotedSubjectChartTabHeader({
    Key? key,
    required this.title,
...
class _TestAllottedChapterChart extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.all(12.w),
...
class _TestAllottedConceptList extends StatelessWidget {
  final List d = [
    1,
    2,
    3,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: d.map((e) {
        ...
        return _TestAllottedConceptListItemCard(
          index: index + 1,
          conceptName:
...
class _TestAllottedConceptListItemCard extends StatelessWidget {
  const _TestAllottedConceptListItemCard({
    Key? key,
    required this.index,
