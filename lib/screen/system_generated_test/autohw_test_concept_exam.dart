...
class AutoHWTestConceptBasedExamPage extends StatefulWidget {
  ...
  const AutoHWTestConceptBasedExamPage({
    Key? key,
  ...
  @override
  State<AutoHWTestConceptBasedExamPage> createState() => _AutoHWTestConceptBasedExamPageState();
}

enum BoolOptions { isTrue, isFalse, isNone }

class _AutoHWTestConceptBasedExamPageState extends State<AutoHWTestConceptBasedExamPage> with SingleTickerProviderStateMixin {
  int _conceptIndex = 1;
  ...
  apiPostProcessing() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      var conceptId = systemGeneratedTestController.systemGeneratedTestModel.value.data?.concept;
      var keylearningId = systemGeneratedTestController.systemGeneratedTestModel.value.data?.keyLearning;

      if (conceptId != null) {
        var conceptIndex = homeworkData!.concepts!.indexWhere((e) => e.concept!.id == conceptId);
        var keyLearningIndex = homeworkData!.concepts![conceptIndex].keyLearnings!.indexWhere((e) => e.keyLearning!.id == keylearningId);

        Future.delayed(const Duration(seconds: 2), () {
          precapController.isKeylearningScreen = false;
          if (_scrollController.hasClients) {
            _scrollController.animateTo(MediaQuery.of(context).size.width * conceptIndex,
        ...
        setState(() {
          ...
          homeworkData = homeworkController.homeworkDetailModel.value.data;
          systemGeneratedTestData = systemGeneratedTestController.systemGeneratedTestModel.value.data;
  ...
  void resetData() {
    ...
    if (systemGeneratedTestController.systemGeneratedTestNoQueFound.isFalse) {
  ...
  void onNextButtonTap() {
    if (hasChooseAnyOption == true && isAnsSubmitted == true) {
      if (systemGeneratedTestController.systemGeneratedTestExamCompleted.isTrue) {
      ...
      systemGeneratedTestController.systemGeneratedTestModel.value =
          systemGeneratedTestController.systemGeneratedTestModelTemp.value; // assign next question data to Question data model
      systemGeneratedTestController.systemGeneratedTestModelTemp.value = SystemGeneratedTestModel(); // clear temp data
    ...
    if (hasChooseAnyOption == false) {
      ...
      systemGeneratedTestController
        ...
        Future.delayed(const Duration(milliseconds: 800), () {
          systemGeneratedTestController.systemGeneratedTestModel.value.data != null
              ? homeworkController
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar:
          ...
          //     ? const SizedBox()
          systemGeneratedTestController.systemGeneratedTestLoading.isFalse && !hasNoQuestionFound
              ? SafeArea(
                  child: Container(
                      ...
                      children: [
                        ...
                        Expanded(
                            child:
                                ...
                                //         needToLoadQuestion == false)
                                //     ?
                                systemGeneratedTestController.systemGeneratedTestLoading.isFalse && isAnsSubmitted
                                    ? InkWell(
      ...
      body: SafeArea(
        child: Obx(
          () => (systemGeneratedTestData == null || (systemGeneratedTestController.systemGeneratedTestNoQueFound.isTrue && isAnsSubmitted == true)) &&
                  hasNoQuestionFound
              ? const NoDataCard(
                  title: "Oops...\n No question found",
                  ...
                  children: [
                    Stack(
                      ...
                      children: [
                                              ...
                                              return Container(
                                                ...
                                                child: Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                        ...
                                                        gradient: homeworkData?.concepts?[index].cleared ?? false ? greenGradient : redGradient),
                        ...
                        (isPostProccesRunning == true || systemGeneratedTestController.systemGeneratedTestLoading.isTrue)
                            ? const LoadingUI()
                            : Container()
                      ],
                    ),
                    (systemGeneratedTestController.systemGeneratedTestNoQueFound.isTrue && isAnsSubmitted == true) && hasNoQuestionFound
                        ? const NoDataCard(
                            title: "Oops...\n No question found",
                            description: "No question found for selected Homework\nkindly contact your teacher.",
                            headerEnabled: true,
