...
import 'package:saarthi_pedagogy_studentapp/screen/dashboard/test_alloted_details.dart';
...
class TestAllotedChart extends StatelessWidget {
  const TestAllotedChart({
    Key? key,
  ...
  void _navigateTopage(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const TestAllotedDetailsPage(),
      ),
    );
  }
